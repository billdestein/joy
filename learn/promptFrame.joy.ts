...
The PromptFrame has a 'prompt' in its message.  The prompt is displayed in the viewport.
...
The cancel button handler calls removes the promptFrame from the canvas.
`
